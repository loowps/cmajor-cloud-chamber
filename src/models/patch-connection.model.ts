export interface PatchConnection {
   ...
   * @param value
   * @param rampFrames
   * @param timeoutMillisecs - how long the runtime should keep retrying if the patch's input
   *   queue is full before giving up on the event. Only worth setting for bulk transfers, which
   *   are the only thing that can outrun the queue.
   */
  sendEventOrValue(
    endpointID: string,
    value: any,
   ...
   * @param shortMIDICode
   */
  sendMIDIInputEvent(endpointID: string, shortMIDICode: number): any
   ...
   * @param listener
   */
  removeEndpointListener(endpointID: string, listener: (value: any) => void): void
   ...
   * @param endpointID
   */
  requestParameterValue(endpointID: string): any
   ...
   * @param listener
   */
  addParameterListener(endpointID: string, listener: (value: any) => void): any
   ...
   * @param listener
   */
  removeParameterListener(endpointID: string, listener: (value: any) => void): any
   ...
   * @param listener
   */
  addAllParameterListener(listener: (args: { endpointID: string; value: any }) => void): any
   ...
   * @param listener
   */
  removeAllParameterListener(listener: (args: { endpointID: string; value: any }) => void): void
